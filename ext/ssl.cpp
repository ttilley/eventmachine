...
SslContext_t::SslContext_t (bool is_server, const std::string &privkeyfile, const std::string &certchainfile, int ssl_version, const std::string &cipherlist):
	pCtx (NULL),
	PrivateKey (NULL),
	Certificate (NULL)
{
...
SslBox_t::SslBox_t (bool is_server, const std::string &privkeyfile, const std::string &certchainfile, bool verify_peer, int ssl_version, const std::string &cipherlist, const unsigned long binding):
	bIsServer (is_server),
